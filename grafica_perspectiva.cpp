...
void Mostrar( GLFWwindow* window ) {
	...
	if(perspectiva){ //haciendo el cambio ortogonal a perspectiva con los valores ingresados
		...
		gluLookAt(Camara_Pos[0], Camara_Pos[1], Camara_Pos[2], Camara_Pos[0] + Camara_Front[0], Camara_Pos[1] + Camara_Front[1], Camara_Pos[2] + Camara_Front[2], Camara_Up[0], Camara_Up[1], Camara_Up[2]);
	} else {
	...
	glColor3d(1.0, 0.0, 0.0); glVertex3d(1.0, 0.0, 0.0); glVertex3d(1.0, 0.0, 0.0);
	glColor3d(0.0, 1.0, 0.0); glVertex3d(0.0, 1.0, 0.0); glVertex3d(0.0, 1.0, 0.0);
	glColor3d(0.0, 0.0, 1.0); glVertex3d(0.0, 0.0, 1.0); glVertex3d(0.0, 0.0, 1.0);
	glEnd();
	glFlush();
